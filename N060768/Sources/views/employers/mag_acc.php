...
<?php
    ...
    if (isset($err_post)) {
        echo "<script>alert('$err_post')</script>";
    }
?>
...
<div class="container">
    ...
    <ul class="nav nav-tabs" role="tablist">
        <li class="nav-item">
            <a class="nav-link" data-toggle="tab" href="#menu1" id='manager-post'>Quản lý bài đăng</a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
            <a class="nav-link active" data-toggle="tab" href="#menu4">Quản lý tài khoản</a>
        </li>
        <li class="nav-item">
    ...
    <div class="tab-content">
        ...
        <!-- Quản lý tài khoản -->
        <div id="menu4 active" class="container tab-pane"><br>
                    ...
                    <div class='col-md-6'>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="" value="<?php 
                                if (isset($manager_account)) echo $manager_account['username'];?>">
                        </div>
                        <div class="form-group">
                            <label for="pwd">Email:</label>
                            <input type="text" class="form-control" name="" value="<?php
                                if (isset($manager_account)) echo $manager_account['email'];?>">
                        </div>
                        <br>
                        <div class="form-group">
                ...
                <div class='row'>
                    <div class='col-md-6'>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" rows='5' name=""><?php if(isset($manager_infor)) { echo $manager_infor->description;}?></textarea>
                        </div>
                        <div class="form-group">
